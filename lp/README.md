...
Queste funzioni implementano principalmente con problemi primali e duali, nei formati standard descriti in _M. Pappalardo, Ricerca Operativa_ (si veda la pagina iniziale del progetto), adattati al formato che si aspetta la funzione `linprog()` dell'Optimization Toolbox di MATLAB.
